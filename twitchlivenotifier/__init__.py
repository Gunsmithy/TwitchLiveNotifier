...
def config():
    ...
    try:
        ...
        print('This can be set to whatver you want the bot to say, with {{Name}} and {{Game}} as placeholders.')
        sys.exit()
    ...
    try:
        ...
        print('Description not found in Discord section of config file. Please set Description under [Discord] in config.ini')
        print('This can be set to whatver you want to appear under the stream title, with {{Name}} and {{Game}} as placeholders.')
        sys.exit()
...
def main():
    ...
    while twitch_json.get('stream', None) is None:
        ...
        if twitch_json['stream'] is not None:
            ...
            discord_payload = { "content": discord_message, "embeds": [ { "title": stream_title, "url": stream_url, "description": discord_description, "thumbnail": { "url": stream_logo } } ] }
